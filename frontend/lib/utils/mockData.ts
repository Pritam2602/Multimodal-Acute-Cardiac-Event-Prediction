...
export const MOCK_ADMISSIONS: Admission[] = [
  {
    ...
    prediction: { predicted_prob: 0.824, threshold: 0.6494, confidence_evolution: [0.24, 0.61, 0.824], dominant_modality: "ECG", attn_temp_entropy: 0.32, attn_spatial_dominance: 0.78, ecg_contribution: 0.68, trop_contribution: 0.32 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.187, threshold: 0.6494, confidence_evolution: [0.21, 0.187], dominant_modality: "Troponin", attn_temp_entropy: 0.71, attn_spatial_dominance: 0.22, ecg_contribution: 0.31, trop_contribution: 0.69 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.961, threshold: 0.6494, confidence_evolution: [0.42, 0.87, 0.961], dominant_modality: "ECG", attn_temp_entropy: 0.18, attn_spatial_dominance: 0.92, ecg_contribution: 0.74, trop_contribution: 0.26 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.043, threshold: 0.6494, confidence_evolution: [0.06, 0.043], dominant_modality: "Troponin", attn_temp_entropy: 0.82, attn_spatial_dominance: 0.14, ecg_contribution: 0.28, trop_contribution: 0.72 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.876, threshold: 0.6494, confidence_evolution: [0.19, 0.54, 0.876], dominant_modality: "Balanced", attn_temp_entropy: 0.28, attn_spatial_dominance: 0.69, ecg_contribution: 0.51, trop_contribution: 0.49 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.312, threshold: 0.6494, confidence_evolution: [0.38, 0.34, 0.312], dominant_modality: "ECG", attn_temp_entropy: 0.66, attn_spatial_dominance: 0.28, ecg_contribution: 0.62, trop_contribution: 0.38 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.948, threshold: 0.6494, confidence_evolution: [0.38, 0.82, 0.948], dominant_modality: "ECG", attn_temp_entropy: 0.21, attn_spatial_dominance: 0.88, ecg_contribution: 0.71, trop_contribution: 0.29 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.028, threshold: 0.6494, confidence_evolution: [0.028], dominant_modality: "Troponin", attn_temp_entropy: 0.91, attn_spatial_dominance: 0.09, ecg_contribution: 0.22, trop_contribution: 0.78 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.791, threshold: 0.6494, confidence_evolution: [0.22, 0.58, 0.791], dominant_modality: "ECG", attn_temp_entropy: 0.35, attn_spatial_dominance: 0.74, ecg_contribution: 0.65, trop_contribution: 0.35 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.092, threshold: 0.6494, confidence_evolution: [0.11, 0.092], dominant_modality: "Troponin", attn_temp_entropy: 0.78, attn_spatial_dominance: 0.18, ecg_contribution: 0.31, trop_contribution: 0.69 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.912, threshold: 0.6494, confidence_evolution: [0.61, 0.84, 0.912], dominant_modality: "Balanced", attn_temp_entropy: 0.24, attn_spatial_dominance: 0.81, ecg_contribution: 0.52, trop_contribution: 0.48 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.134, threshold: 0.6494, confidence_evolution: [0.16, 0.134], dominant_modality: "Troponin", attn_temp_entropy: 0.75, attn_spatial_dominance: 0.21, ecg_contribution: 0.34, trop_contribution: 0.66 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.843, threshold: 0.6494, confidence_evolution: [0.31, 0.843], dominant_modality: "Balanced", attn_temp_entropy: 0.29, attn_spatial_dominance: 0.72, ecg_contribution: 0.54, trop_contribution: 0.46 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.274, threshold: 0.6494, confidence_evolution: [0.35, 0.30, 0.274], dominant_modality: "ECG", attn_temp_entropy: 0.63, attn_spatial_dominance: 0.31, ecg_contribution: 0.59, trop_contribution: 0.41 },
  ...
  },
  {
    ...
    prediction: { predicted_prob: 0.936, threshold: 0.6494, confidence_evolution: [0.41, 0.78, 0.936], dominant_modality: "ECG", attn_temp_entropy: 0.22, attn_spatial_dominance: 0.86, ecg_contribution: 0.69, trop_contribution: 0.31 },
...
export function getPredictionColor(prob: number): string {
  ...
  if (prob >= 0.6494) return "text-orange-400";
